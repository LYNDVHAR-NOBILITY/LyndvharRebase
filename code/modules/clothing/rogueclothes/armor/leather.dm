...
/obj/item/clothing/suit/roguetown/armor/leather/heavy/coat/confessor
	...
	desc = "A sturdy raincoat draped atop of a tightly-fastened boiled leather cuirass. Psydonic youths often fashion little pieces of memorabilia and stitch it on the inner pockets of the coat to remind the confessors that their cause is virtuous, and that they mustn't lose sight of what matters."
