...
/obj/item/rogueweapon/mace/warhammer
	...
	name = "warhammer"
	desc = "A one-handed derivative of the mace, purpose-made to defeat armored opponents in battle. Paired nicely with a mug of Lyndvhar's finest zenny-liqour and a heater shield."
